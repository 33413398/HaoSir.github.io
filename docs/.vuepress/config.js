...
module.exports = {
    ...
    head: [
        ...
        ["meta", { name: "Keywords", content: "郝先生,郝先生的主页" }],
        // 作者
        ["meta", { name: "author", content: "郝先生,郝先生的主页" }],
        // 百度统计
        [
            "script",
            {},
    ...
    themeConfig: {
        ...
        nav: [
            ...
            { text: "主页", link: "/", icon: "reco-home" },
            {
                ...
                items: [
                    { text: "前站导航", link: "http://www.frontendjs.com/" },
            ...
            },
            {
                text: "项目",
                icon: "iconfont icon-tools",
                items: [{ text: "Vue仿x小米电商", link: "http://h33413398.host3v.com/#/index", icon: "iconfont icon-vue" }],
            },
            ...
            { text: "留言板", link: "/views/others/message", icon: "reco-message" },
            {
                ...
                items: [
                    ...
                    {
                        text: "CSDN",
                        link: "https://blog.csdn.net/h33413398",
                        icon: "reco-csdn",
                    },
                    {
                        text: "GitHub",
                        link: "https://github.com/33413398",
                        icon: "reco-github",
                    },
                ],
            },
    ...
    plugins: {
        ...
        //     metingApi: "https://autumnfish.cn/song/url?id=1830725989",
        //     meting: {
        //         server: "netease",
        //         type: "playlist",
        //         mid: "2539599584",
        ...
        //   qq: "33413398",
        //   email: "33413398@gmail.com", //email地址
        // },
